...
const MinusSquareO: React.FC <IconProps> = ({ style, ...rest }) => (
  <svg style={style} {...rest} viewBox="64 -65 897 897">
    <g>
      <path
...
const PlusSquareO: React.FC <IconProps> = ({ style, ...rest }) => (
  <svg style={style} {...rest} viewBox="64 -65 897 897">
    <g>
      <path
...
const CloseSquareO: React.FC <IconProps> = ({ style, ...rest }) => (
  <svg style={style} {...rest} viewBox="64 -65 897 897">
    <g>
      <path
